...
public class SqliteConfig {
    ...
    public static final String CONST_SQLITE_FILE_PATH = "com.fxm.local.collection.sqlite.file.path";
    public static final String DEFAULT_SQLITE_FILE_PATH = "./local_collection/sqlite/fxm_local_collection_";
    public static final String CONST_SQLITE_USERNAME = "com.fxm.local.collection.sqlite.file.username";
    public static final String CONST_SQLITE_PASSWORD = "com.fxm.local.collection.sqlite.file.password";
