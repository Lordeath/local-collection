...
public class HSQLDBConfig {
    ...
    public static final String CONST_HSQLDB_FILE_PATH = "com.fxm.local.collection.hsqldb.file.path";
    public static final String DEFAULT_HSQLDB_FILE_PATH = "./local_collection/hsqldb/fxm_local_collection_";
    public static final String CONST_HSQLDB_USERNAME = "com.fxm.local.collection.hsqldb.file.username";
    public static final String CONST_HSQLDB_PASSWORD = "com.fxm.local.collection.hsqldb.file.password";
