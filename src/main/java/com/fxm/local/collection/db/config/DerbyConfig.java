...
public class DerbyConfig {
    ...
    public static final String CONST_DERBY_FILE_PATH = "com.fxm.local.collection.derby.file.path";
    public static final String DEFAULT_DERBY_FILE_PATH = "./local_collection/derby/fxm_local_collection_";
    public static final String CONST_DERBY_USERNAME = "com.fxm.local.collection.derby.file.username";
    public static final String CONST_DERBY_PASSWORD = "com.fxm.local.collection.derby.file.password";
